...
<head>
	...
	<title>Login</title>
	<link rel="shortcut icon" href="<?php echo base_url();?>assetku/img/website.ico" type="image/x-icon" />
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel ">
                    ...
                    <div class="panel-heading">
						<img src="<?php echo base_url(); ?>assetku/img/logo_website.png" class="img-responsive"> 						
                    </div>
					...
					<div class="panel-footer" style="background:#0b5708;">
						<span align="center" style="color:white;">Copyleft KKN UNS &copy<a style="color:white;" href="<?php echo site_url('c_login');?>">2017 </a><span>
					</div>
                </div>
            </div>
        </div>
