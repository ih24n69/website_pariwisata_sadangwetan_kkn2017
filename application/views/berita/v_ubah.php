...
<legend></legend>
	<div class="form-group"> 
    	<label class="col-md-2 control-label" for="judul_berita">Judul Post </label>
        <div class="col-md-10">
        <input class="form-control input-md"  type="text" name="judul_berita" id="judul_berita" placeholder="Judul Post"value="<?= $hasil->judul_berita ?>"/>
	...
	<div class="form-group"> 
		<div class="image-editor ">	
			<label class="col-md-2 control-label" for="">Gambar Post</label>
			<div class="col-md-10">
				<div id="lihat">
...
<div class="form-group"> 
	<label class="col-md-2 control-label" for="isi_berita">Post</label>
	 <div class="col-md-10">
