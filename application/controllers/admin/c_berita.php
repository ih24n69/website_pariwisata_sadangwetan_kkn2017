...
class C_berita extends CI_Controller {
    ...
    $colModel['judul_berita'] = array('Judul Post',400,TRUE,'center',2);
	
	$colModel['waktu'] = array('Waktu Post',100,TRUE,'center',2);
	$colModel['aksi'] = array('AKSI',60,FALSE,'center',0);
        ...
        $data['page_title'] = 'PARIWISATA DESA';		
